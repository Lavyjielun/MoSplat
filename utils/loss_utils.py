...
def limb_3d_consistency_loss(gaussians_xyz, data_root, reduction="mean"):
    ...
    if "h36m" in data_root:
        ...
        l_arm = torch.norm(gaussians_xyz[7, ...] - gaussians_xyz[9, ...], dim=-1)
        r_arm = torch.norm(gaussians_xyz[8, ...] - gaussians_xyz[10, ...], dim=-1)
        l_leg = torch.norm(gaussians_xyz[13, ...] - gaussians_xyz[15, ...], dim=-1)
        r_leg = torch.norm(gaussians_xyz[14, ...] - gaussians_xyz[16, ...], dim=-1)
        ...
        l_leg = torch.norm(gaussians_xyz[5, ...] - gaussians_xyz[6, ...], dim=-1)
        r_leg = torch.norm(gaussians_xyz[2, ...] - gaussians_xyz[3, ...], dim=-1)
    elif "foshan" in data_root:
        l_arm = torch.norm(gaussians_xyz[12, ...] - gaussians_xyz[13, ...], dim=-1)
        r_arm = torch.norm(gaussians_xyz[9, ...] - gaussians_xyz[10, ...], dim=-1)
        l_leg = torch.norm(gaussians_xyz[2, ...] - gaussians_xyz[3, ...], dim=-1)
        r_leg = torch.norm(gaussians_xyz[5, ...] - gaussians_xyz[6, ...], dim=-1)        
